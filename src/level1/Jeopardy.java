...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel header = createHeader("Extinct Animals");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("Which extinct animal was found on an uninhabited island?","Dodo Bird",200);
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("Who was the biggest carnivorous dinosaur?","Spinosaurus",400);
		}
		else if (buttonPressed == thirdButton) {
			// Call the askQuestion() method with a harder question
			askQuestion("Which extinct bird had NO WINGS?","Moa",600);	
		}
